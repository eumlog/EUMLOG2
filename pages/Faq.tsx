...
const FaqPage = () => {
    ...
    const faqData: FAQItem[] = [
        ...
        { q: "소개는 얼마나 자주 오나요?", a: "5~7일 간격으로 1명씩, 총 12명의 프로필이 보장됩니다. (일반적으로 약 3개월 소요)" },
        ...
        { q: "비용 구조가 헷갈려요.", a: "멤버십비(기본 12회 소개 비용)와 성사비(만남 확정 시에만 발생) 두 가지입니다. 소개만 받고 만남이 없으면 추가 비용 없습니다." },
        { q: "애프터케어가 뭔가요?", a: "기본 진행 12회가 끝난 이후에도 나를 선택한 사람이 생기면 연결해 드립니다. 총 24회 진행 (약 6개월 소요)." },
