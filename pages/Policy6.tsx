      ...
      <section className="py-8 md:py-16 px-4 md:px-6">
        <div className="max-w-[900px] mx-auto bg-white p-6 md:p-12 rounded-[2rem] md:rounded-3xl border border-gray-100 shadow-sm text-gray-800 leading-relaxed">
          ...
          <div className="mb-10 md:mb-16">
              ...
              <table className="w-full text-[10px] md:text-sm border-t border-gray-200 text-center min-w-[320px]">
                <thead className="bg-gray-50/80">
                  <tr>
                    ...
                    <th className="py-2.5 px-2 font-bold text-gray-600 border-b border-gray-100">라이트 (Lite)</th>
                    <th className="py-2.5 px-2 font-bold text-eum-accent border-b border-gray-100">스탠다드 (Standard)</th>
                    <th className="py-2.5 px-2 font-bold text-gray-600 border-b border-gray-100">프리미엄 (Premium)</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-50">
                   <tr>
                   ...
                   <tr>
                     ...
                     <td className="py-3 px-2 font-bold text-eum-accent">230,000원</td>
            ...
            <p className="text-[10px] md:text-sm text-gray-500 mb-3">실제 만남이 확정될 경우 발생하는 비용이며, 이용 중인 플랜에 따라 차등 적용됩니다.</p>
            <div className="overflow-x-auto -mx-2 px-2 pb-2">
              <table className="w-full text-[10px] md:text-sm border-t border-gray-200 text-center min-w-[320px]">
                <thead className="bg-gray-50/80">
                  <tr>
                    <th className="py-2.5 px-2 font-bold text-gray-600 border-b border-gray-100">구분</th>
                    <th className="py-2.5 px-2 font-bold text-gray-600 border-b border-gray-100">라이트</th>
                    <th className="py-2.5 px-2 font-bold text-eum-accent border-b border-gray-100">스탠다드</th>
                    <th className="py-2.5 px-2 font-bold text-gray-600 border-b border-gray-100">프리미엄</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-50">
                   <tr>
              ...
              <p className="mt-2 text-[9px] md:text-xs text-gray-400 font-medium">※ 1회 매칭 성사 시마다 발생하는 비용입니다.</p>
            </div>
          </div>
          ...
          <div className="mt-10 md:mt-16">
             <h3 className="text-lg md:text-2xl font-black text-eum-dark mb-4">VI. 프리미엄 만남 보장 환불 규정</h3>
             <p className="text-[10px] md:text-sm text-gray-500 mb-4 leading-relaxed">
               기본 프로필 12회 제공 완료 후에도 프리미엄 만남 보장은 <strong className="text-eum-dark">'만남 3회 달성 시까지'</strong> 추가 소개가 제공됩니다.
             </p>
             <p className="text-[10px] md:text-sm text-gray-500 mb-6 leading-relaxed">
               다만, <strong className="text-eum-dark">회원 수급 부족 등으로 프리미엄 만남 보장 서비스의 원활한 제공이 어려운 경우</strong>, 회사는 회원에게 해당 사실을 안내하며 회원은 아래 중 하나를 선택할 수 있습니다.
             </p>

             <ul className="space-y-4 mb-8 pl-1">
               <li className="flex items-start gap-2.5">
                 <span className="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-eum-accent mt-1.5"></span>
                 <div>
                   <strong className="text-gray-900 text-[11px] md:text-base">서비스 계속 진행:</strong>
                   <p className="text-gray-500 text-[10px] md:text-sm mt-1">제공 주기는 보장되지 않으며, 회원 수급 상황에 따라 순차적으로 추가 소개를 제공합니다.</p>
                 </div>
               </li>
               <li className="flex items-start gap-2.5">
                 <span className="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-eum-accent mt-1.5"></span>
                 <div>
                   <strong className="text-gray-900 text-[11px] md:text-base">서비스 종료:</strong>
                   <p className="text-gray-500 text-[10px] md:text-sm mt-1">미달성된 만남 횟수에 따라 아래 기준으로 환불 후 서비스를 종료합니다.</p>
                 </div>
               </li>
             </ul>
             ...
             <div className="overflow-x-auto -mx-2 px-2 pb-2">
                 <table className="w-full text-[10px] md:text-sm border-t border-gray-200 text-center min-w-[320px]">
                     <thead className="bg-gray-50/50">
                         <tr>
                             <th className="py-2.5 px-3 font-bold text-gray-600 border-b border-gray-100 w-1/2">만남 성사 횟수</th>
                             <th className="py-2.5 px-3 font-bold text-gray-600 border-b border-gray-100 w-1/2">환불 금액</th>
                         </tr>
                     </thead>
                     <tbody className="divide-y divide-gray-50">
                         <tr>
                             <td className="py-3 px-3 font-bold bg-gray-50/30 text-gray-700">0회</td>
                             <td className="py-3 px-3 font-bold text-red-500">100,000원</td>
                         </tr>
                         <tr>
                             <td className="py-3 px-3 font-bold bg-gray-50/30 text-gray-700">1회</td>
                             <td className="py-3 px-3 font-bold text-red-500">60,000원</td>
                         </tr>
                         <tr>
                             <td className="py-3 px-3 font-bold bg-gray-50/30 text-gray-700">2회</td>
                             <td className="py-3 px-3 font-bold text-red-500">30,000원</td>
                         </tr>
                         <tr>
                             <td className="py-3 px-3 font-bold bg-gray-50/30 text-gray-700">3회</td>
                             <td className="py-3 px-3 font-bold text-gray-400">환불 없음</td>
                         </tr>
                     </tbody>
                 </table>
             </div>
