                ...
                <tbody className="divide-y divide-gray-50">
                   ...
                   <tr>
                     ...
                     <td className="py-2 px-3">
                       ...
                       <span className="text-[9px] md:text-xs text-gray-400">※ 신중한 매칭을 위해 주기는 유동적일 수 있으나, 주 1회 제공은 보장합니다.</span>
                     </td>
                   </tr>
                   <tr>
                   ...
                   <tr>
                     ...
                     <td className="py-2 px-3">
                       3개월 기간이 종료된 후에도, <span className="font-bold text-eum-dark">나를 선택한 상대가 있다면</span> 해당 프로필 무료 제공<br/>
              ...
              <table className="w-full text-[10px] md:text-sm border-t border-gray-200 text-center min-w-[320px]">
                ...
                <tbody className="divide-y divide-gray-50">
                   ...
                   <tr className="bg-eum-bg/20">
                     ...
                     <td className="py-3 px-2 text-[9px] md:text-xs font-bold text-eum-accent">에프터 케어 포함</td>
                     <td className="py-3 px-2 text-[9px] md:text-xs font-bold">에프터 케어 + 만남 보장</td>
                   </tr>
                </tbody>
              </table>
            </div>
