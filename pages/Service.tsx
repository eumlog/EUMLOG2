...
const Service: React.FC = () => {
      ...
      content: (
          <div className="space-y-4">
              ...
              <div className="flex items-center gap-4 bg-eum-accent/5 p-5 rounded-2xl border border-eum-accent/10">
                  ...
                  <span className="text-[13px] font-bold text-eum-accent leading-snug">원하는 조건들을 하나씩 짚어보며 실제 매칭 가능성을 높이는 소통의 시간입니다.</span>
              </div>
          </div>
      ),
  ...
  return (
    <div className="bg-white min-h-screen">
      <PageHeader title="이음로그 진행 방식" subtitle="Our Process" />
      
      <section ref={containerRef} className="py-16 md:py-24 px-8 bg-eum-bg">
        <div className="max-w-2xl mx-auto text-center mb-16 md:mb-24">
          <h2 className="text-2xl md:text-4xl font-black mb-6 text-eum-dark tracking-tighter leading-tight">
            이음로그 진행 방식
          </h2>
