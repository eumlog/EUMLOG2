...
const Service: React.FC = () => {
  ...
  const steps = [
      ...
      content: (
          <div className="space-y-4">
              ...
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                  ...
                  <div className="grid grid-cols-1 gap-2 text-[13px] text-gray-500 font-bold">
    ...
    },
    {
      ...
      content: (
          <div className="space-y-4">
              <p className="text-gray-600 text-base leading-relaxed keep-all font-medium">
                  카톡으로 매니저와 5~10분간 선택한 필수 조건들에 대해 상담합니다.
              </p>
              <div className="flex items-center gap-4 bg-eum-accent/5 p-5 rounded-2xl border border-eum-accent/10">
                  ...
                  <span className="text-[13px] font-bold text-eum-accent leading-snug">조건들을 하나씩 짚어보며 매칭 가능성을 높이는 소통의 시간입니다.</span>
              </div>
          </div>
      ),
          ...
          <div className="space-y-5">
              ...
              <div className="bg-eum-dark text-white p-6 rounded-3xl shadow-inner relative overflow-hidden">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-[9px] font-bold text-eum-accent tracking-widest uppercase">지인 차단 시스템 작동 방식</span>
                  </div>
                  <ul className="space-y-3 text-[12px] font-mono relative z-10">
                      <li className="flex justify-between items-center py-1 text-eum-accent font-black scale-105">
                          <span>ㄱㅁㅅ / 92 / 광양</span> <span className="text-[8px] bg-eum-accent text-white px-2 rounded">진짜 상대</span>
                      </li>
                      <li className="flex justify-between items-center pb-2 border-b border-white/10 opacity-40">
                          <span>ㅈㅇㅎ / 95 / 순천</span> <span className="text-[8px] border border-white/20 px-1.5 rounded">랜덤</span>
                      </li>
                      <li className="flex justify-between items-center pt-2 opacity-40">
                          <span>ㄱㅎㄴ / 93 / 여수</span> <span className="text-[8px] border border-white/20 px-1.5 rounded">랜덤</span>
                      </li>
                  </ul>
              </div>
          ...
          <div className="space-y-5">
              <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className="bg-eum-dark text-white text-[10px] font-bold px-3 py-1 rounded-full">[최소 12회] 제공 보장</span>
                  </div>
              </div>
              <div className="p-5 bg-blue-50 text-blue-600 text-[12px] font-bold rounded-2xl border border-blue-100 leading-relaxed">
    ...
    },
    {
      ...
      content: (
          <div className="space-y-6">
              <div className="bg-white p-7 rounded-[2rem] border border-gray-100 shadow-[0_15px_45px_rgba(0,0,0,0.03)] text-center">
                <p className="text-gray-900 text-base md:text-lg leading-relaxed keep-all font-bold">
      ...
      content: (
          <div className="space-y-4">
              ...
              <div className="bg-eum-bg/50 p-5 rounded-2xl border border-gray-200/50 flex items-center gap-5">
                  ...
                  <span className="text-[13px] font-bold text-gray-600 italic leading-snug keep-all">💡 피드백은 다음 매칭 때 반영돼 성공률을 높이는 데 큰 도움이 됩니다.</span>
              </div>
          </div>
      ),
  ...
  return (
    <div className="bg-white min-h-screen">
      <section ref={containerRef} className="pt-32 pb-16 md:pt-40 md:pb-24 px-8 bg-eum-bg">
        <div className="max-w-2xl mx-auto text-center mb-16 md:mb-24">
          <span className="inline-block px-3 py-1 mb-4 rounded-full bg-eum-accent/10 text-eum-accent text-[12px] font-black tracking-widest uppercase">
            Process
          </span>
          <h2 className="text-3xl md:text-4xl font-black text-eum-dark tracking-tighter leading-tight">
            이음로그 진행 방식
          </h2>
        </div>
        <div className="max-w-xl mx-auto space-y-16 md:space-y-20 relative">
          ...
          {steps.map((item, index) => (
            <div key={index} className="process-card relative z-10">
              ...
              <div className="bg-white rounded-[2rem] md:rounded-[2.5rem] shadow-[0_30px_100px_rgba(0,0,0,0.05)] border border-white p-7 md:p-10 transition-all duration-500 group">
                
                {/* 1. TITLE AREA (Above Image) */}
                <div className="mb-6 md:mb-8">
                  <div className="flex items-center gap-3 mb-3 md:mb-4">
                     <div className="h-[2px] w-6 md:w-8 bg-eum-accent/30"></div>
                     <span className="text-eum-accent text-[10px] font-black tracking-[0.2em] uppercase">
                       {item.subtitle}
                     </span>
                  </div>
                  
                  <h3 className="text-xl md:text-2xl font-black text-eum-dark tracking-tight flex items-center gap-3">
                    <span className="md:hidden flex-shrink-0 w-7 h-7 bg-eum-dark text-white rounded-full flex items-center justify-center text-[10px]">{item.step}</span>
                    {item.title}
                  </h3>
                </div>
